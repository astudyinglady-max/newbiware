...
export default function ShaderShowcase({ headline, subHeadline, ctaPrimary, ctaSecondary }: HeroProps) {
    ...
    return (
        <div ref={containerRef} className="min-h-[40vh] h-[50vh] sm:min-h-[520px] md:h-[690px] bg-black relative overflow-hidden flex flex-col justify-center items-center px-4 sm:px-0 lg:px-12">
