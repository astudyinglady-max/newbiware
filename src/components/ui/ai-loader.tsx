...
/**
 * Background-only version of AiLoader (no fixed overlay).
 * Renders as an absolute-fill layer you can place behind other content.
 */
export const AiLoaderBackground: React.FC<LoaderProps> = ({ size = 180, text = "UBcare" }) => {
  const letters = text.split("");

  return (
    <div className="absolute inset-0 z-0 flex items-center justify-center bg-gradient-to-b from-[#9CAFB7] via-[#0055ff] to-[#1a3379]">
      <div
        className="relative flex items-center justify-center font-inter select-none"
        style={{ width: size, height: size }}
      >
