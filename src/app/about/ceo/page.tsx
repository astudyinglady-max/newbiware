  ...
  return (
    ...
    >
      <div className="space-y-6 text-slate-700 text-lg sm:text-xl leading-relaxed py-0 sm:py-12">
        ...
        헬스케어 신규사업에 집중하여 의미 있는 성장&apos;을 이루어 내겠습니다.
        </p>
        <p className="text-slate-600 font-reguler break-keep">
          유비케어는 국내 최초로 의원용 EMR(Electronic Medical Record) Solution을 개발하여 출시한 기업입니다. <br />이를 바탕으로 병·의원·약국 맞춤형 의료기기 제공,
          병·의원·약국 온라인 쇼핑몰 서비스 제공, 의약품 데이터 및 시장분석 서비스 제공, <br />제약 회사용 온라인 마케팅 채널 제공 등 대한민국 디지털 헬스케어의 모든 분야를 선도해 가고 있습니다.
        </p>
        <p className="text-slate-600 font-reguler break-keep">
