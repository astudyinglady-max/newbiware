...
전국 25,700여 병의원/약국(17,700여 개의 병원, 의원, 8,000여 개 약국)과 38개에 이르는 전국 법인 대리점을 포함한 국내 최대 의료 네트워크를 보유하고 있으며, 이를 바탕으로 EMR, 유통, 제약/데이터 등의 사업을 영위하고 있습니다. <br />
새로운 도전에 망설이지 않고 시장을 선도해 온 유비케어는 헬스케어에 최신 ICT 기술을 융합 및 접목하여 개인 및 나아가 대한민국 사회에 효과적인 맞춤형 헬스케어를 제공하여 국민건강 증진 및 의료비 절감에 기여하도록 하겠습니다 .    
          </p>
        </div>
        <OverviewGridSection />
      </div>
